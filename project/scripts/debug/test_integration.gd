...
func run() -> void:
	...
	check(get_nodes_in_group("destructible").size() == 14, "14 authored breakable segments")
	...
	print("INTEGRATION METRICS peak_speed=", peak, " max_rigidbodies=",max_bodies," events=",manager.event_count," bad_frames=",bad_frames)
